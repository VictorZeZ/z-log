...
export default function Form() {
  ...
  return (
    <motion.div
      ...
      className="xs:h-auto xs:w-100 xs:rounded-lg xs:pt-0 xs:backdrop-blur-[2px] relative flex h-dvh w-full transform-gpu flex-col items-center border bg-neutral-200/90 pt-10 pb-6 shadow-2xl will-change-transform sm:bg-neutral-200/50 md:h-min dark:bg-neutral-900/90 sm:dark:bg-neutral-900/50"
    >
